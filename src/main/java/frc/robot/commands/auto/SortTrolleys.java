...
public class SortTrolleys extends SequentialCommandGroup{
    ...
    public SortTrolleys(){
        super(
            ...
            // For red target
            //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            new GotoTrolley(Layout.T1Pos),  //Change trolley to match target. Eg Trolley 1 to red
            new Align2Trolley(),
            new TrolleyHolder(1),
            //removes obstacle
            new InstantCommand(()-> RobotContainer.m_points.removeObs("T1")),  //This also must change to trolley# 
            // Go to color
            new InstantCommand(()-> RobotContainer.m_vision.setColor("Red")),
            ...
            //### Green target ###//
            new GotoTrolley(Layout.T2Pos),   //Change trolley !!!!!!!!!!!!
            new Align2Trolley(),
            new TrolleyHolder(1),
            //removes obstacle
            new InstantCommand(()-> RobotContainer.m_points.removeObs("T2")),  //Change trolley !!!!!!!!!!!!
            // Go to color
            new InstantCommand(()-> RobotContainer.m_vision.setColor("Green")),
            ...
            //### Blue target ###//
            new GotoTrolley(Layout.T3Pos),  //change trolley !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            new Align2Trolley(),
            new TrolleyHolder(1),
            //removes obstacle
            new InstantCommand(()-> RobotContainer.m_points.removeObs("T3")),  //change trolley  !!!!!!!!!!!
            // Go to color
