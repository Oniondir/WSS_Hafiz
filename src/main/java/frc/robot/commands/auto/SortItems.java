  ...
  public SortItems() 
    {
        ...
        new SelectCommand(
            Map.ofEntries(
                //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                // Assign Trolley to Color first
                // Sorttrolley.java also must change
                Map.entry(CommandSelector.ONE, new GotoTrolley(Layout.T1Pos)),  //ONE is red
                Map.entry(CommandSelector.TWO, new GotoTrolley(Layout.T2Pos)),  //TWO is green
                Map.entry(CommandSelector.THREE, new GotoTrolley(Layout.T3Pos)) //THREE is blue
                ), 
