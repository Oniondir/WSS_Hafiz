...
public class Layout {
    ...
    public static final Pose2d PickUpBin2Pos = new Pose2d(0.2, 4.27-0.72,  new Rotation2d(0) );
    ...
    public static final Pose2d workOrderPos = new Pose2d(1.18, 0.250,  new Rotation2d(Math.toRadians(-90)));

    // Robot start position.
    public static final Pose2d startPos = new Pose2d(0.3, 0.3, new Rotation2d(-Math.PI/4) ); //For task A
    // public static final Pose2d startPos = new Pose2d(0.96,1.1, new Rotation2d(-Math.PI/2) ); //For open house/testing
    // public static final Pose2d startPos = new Pose2d(0.21,0.21, new Rotation2d(-Math.PI/2) ); //For all core programming tasks
